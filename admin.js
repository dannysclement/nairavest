import {db,collection,doc,setDoc,getDoc,getDocs,query,where,updateDoc,addDoc,serverTimestamp,runTransaction} from "./firebase.js";
...
window.saveAdminSettings=async()=>{
 try{
  await setDoc(doc(db,"settings","main"),{
   feePercent:Number(document.getElementById("adminFeePercent").value),
   feePerNaira:Number(document.getElementById("adminFeePerNaira").value),
   referralPercent:Number(document.getElementById("adminReferralPercent").value)
  },{merge:true});
